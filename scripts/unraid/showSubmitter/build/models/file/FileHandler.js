System.register(["fs", "../Episode"], function (exports_1, context_1) {
    "use strict";
    ...
    var fs_1, Episode_1, FileHandler;
    ...
    return {
        setters: [
            ...
            function (Episode_1_1) {
                Episode_1 = Episode_1_1;
            }
        ],
        execute: function () {
            FileHandler = class FileHandler {
                constructor(folder) {
                    this.folder = folder;
                }
                _getDirectories(source) {
                    return fs_1.default.readdirSync(source, {
                        withFileTypes: true
                    })
                ...
                _seriesAccumulator(seriesAcc, series) {
                    ...
                    const seasonAccumulator = (seasonAcc, season) => {
                        ...
                        const files = fs_1.default.readdirSync(seasonPath);
                ...
                renameEpisodeFiles(fileToRename, episodeText, series, season) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const files = fs_1.default.readdirSync(seasonFolder);
                            ...
                            files.forEach(function (file) {
                                if (file.includes(`${fileToRename}.`) || file.includes(`${fileToRename}-`)) {
                                    ...
                                    if (file.includes(".description") || file.includes(".json")) {
                                        ...
                                        fs_1.default.renameSync(filePath, [seasonFolder, newName].join('/'));
                                    }
                                }
                            });
                        }
                            ...
                            files.forEach(function (file) {
                                if (file.includes(fileToRename)) {
                                    ...
                                    if (!fs_1.default.existsSync(errorDir)) {
                                        fs_1.default.mkdirSync(errorDir);
                                    }
                                    fs_1.default.renameSync([seasonFolder, file].join('/'), [errorDir, file].join('/'));
                                }
                            });
                        }
